...
const translations: Record<string, Dictionary> = {
  en: {
    ...
    "local.section.appCount": "{count} apps installed",
    ...
    "addSkill.github.description":
      "Enter a GitHub repository URL or skill directory URL containing the skill.",
    ...
    "agentApps.subtitle": "Manage agent applications for skill installation",
    "agentApps.viewButton": "View",
    "agentApps.configButton": "Configure",
    "agentApps.modalTitle": "Agent Apps",
    "agentApps.internalSection": "Internal Agent Apps",
    "agentApps.userSection": "Custom Apps",
    "agentApps.installed": "Installed",
    "agentApps.notInstalled": "Not installed",
    "agentApps.missingMyApp": "Missing My Agent App?",
    "agentApps.manualAdd": "Add",
    ...
    "agentApps.detect": "Detect",
    "agentApps.add": "Add",
    "agentApps.save": "Save",
    "agentApps.cancel": "Cancel",
    "agentApps.remove": "Remove",
    "agentApps.removeConfirm": "Remove this agent app?",
    "agentApps.pathExists": "This global path already exists",
    "agentApps.nameExists": "An agent app with similar name already exists",
    "agentApps.addSuccess": "Agent app added successfully",
  ...
  zh: {
    ...
    "addSkill.github.description": "输入包含 skill 的 GitHub 仓库地址或 skill 目录地址",
    "addSkill.github.urlPlaceholder": "https://github.com/owner/repo",
    ...
    "agentApps.subtitle": "管理用于技能安装的 Agent 应用",
    "agentApps.viewButton": "查看",
    "agentApps.configButton": "配置",
    "agentApps.modalTitle": "Agent 应用",
    "agentApps.internalSection": "内置 Agent 应用",
    "agentApps.userSection": "自定义应用",
    "agentApps.installed": "已安装",
    "agentApps.notInstalled": "未安装",
    "agentApps.missingMyApp": "没有我的 Agent 应用？",
    "agentApps.manualAdd": "添加",
    ...
    "agentApps.pathExists": "此全局路径已存在",
    "agentApps.nameExists": "已存在类似名称的 Agent 应用",
    "agentApps.addSuccess": "Agent 应用添加成功",
