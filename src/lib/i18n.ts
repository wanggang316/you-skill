...
const translations: Record<string, Dictionary> = {
  en: {
    ...
    "local.updateAll": "Update all ({count})",
    "local.updateAllRunning": "Updating {completed}/{total}...",
    "local.updateAllFailed": "Failed to update {count} skills: {names}",
    ...
    "addSkill.zip.selectSkill": "Select skills to install:",
    ...
    "addSkill.folder.selectSkill": "Select skills to install:",
    ...
    "addSkill.github.selectSkill": "Select skills to install:",
  ...
  zh: {
    ...
    "local.updateAll": "全部更新（{count}）",
    "local.updateAllRunning": "更新中 {completed}/{total}...",
    "local.updateAllFailed": "以下 {count} 个技能更新失败：{names}",
