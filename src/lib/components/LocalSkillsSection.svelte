...
<section class="space-y-6">
  ...
  <div class="space-y-3">
    ...
    {:else}
      <div class="space-y-2">
        <p class="text-sm font-semibold text-base-content-muted">
        ...
        {#if managedSkills.length === 0}
          ...
          >
            ...
            {#if unmanagedSkills.length > 0}
              ...
              <button
                class="inline-flex items-center rounded-xl bg-warning px-4 py-2 text-sm font-medium text-warning-content transition hover:bg-warning-hover"
        ...
        {:else}
          {#each managedSkills as skill}
            <div
              class="group rounded-2xl border border-base-300 bg-base-100 p-4 transition hover:bg-base-200 hover:shadow-sm cursor-pointer"
            ...
            >
              <div class="flex flex-wrap items-center justify-between gap-3">
                <div class="flex-1">
                  ...
                  <p class="mt-2 text-xs text-base-content-subtle">
                ...
                <div
                  class="flex items-center gap-3 text-xs text-base-content-faint opacity-0 group-hover:opacity-100 transition-opacity"
                ...
                >
                  <IconButton
                    variant="outline"
                    class="rounded-lg p-2 text-xs border-base-300 text-base-content-muted"
                    onclick={(e) => {
                      e?.stopPropagation();
                  ...
                  <IconButton
                    variant="outline"
                    class="rounded-lg border-error-border p-2 text-xs text-error"
                    onclick={(event) => {
