  ...
  >
    <div class="flex max-h-[90vh] w-full max-w-lg flex-col rounded-2xl border border-[var(--base-300)] bg-[var(--base-100)] shadow-xl">
      ...
      <div class="flex items-center justify-between border-b border-[var(--base-300)] px-6 py-4">
        <h2 class="text-lg font-semibold">{$t('addSkill.title')}</h2>
        <button
      ...
      <div class="flex-1 overflow-y-auto p-6">
        ...
        <div class="mb-6 flex gap-2 rounded-full bg-[var(--base-200)] p-1">
          <button
            class={`flex flex-1 items-center justify-center gap-2 rounded-full px-4 py-2 text-sm transition ${activeTab === 'zip' ? 'bg-[var(--base-100)] text-[var(--base-content)] shadow-sm' : 'text-[var(--base-content-muted)] hover:text-[var(--base-content)]'}`}
          ...
          <button
            class={`flex flex-1 items-center justify-center gap-2 rounded-full px-4 py-2 text-sm transition ${activeTab === 'github' ? 'bg-[var(--base-100)] text-[var(--base-content)] shadow-sm' : 'text-[var(--base-content-muted)] hover:text-[var(--base-content)]'}`}
        ...
        {#if activeTab === 'zip'}
          <div class="space-y-4">
            ...
            >
              {#if selectedZipPath}
                <div class="flex items-center justify-center gap-2 text-[var(--base-content)]">
              ...
              {:else}
                <div class="flex flex-col items-center gap-2 text-[var(--base-content-muted)]">
                  <FileArchive size={32} />
        ...
        {:else}
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-2">
              ...
              />
              <button
                class="rounded-xl bg-[var(--primary)] px-4 py-2 text-sm text-[var(--primary-content)] transition hover:opacity-90 disabled:opacity-50"
                ...
                <div class="max-h-48 space-y-2 overflow-y-auto rounded-xl border border-[var(--base-300)] bg-[var(--base-200)] p-2">
                  {#each detectedSkills as skill}
                    ...
                    >
                      <div>
                        <p class="font-medium">{skill.name}</p>
                        <p class={`text-xs ${selectedSkill?.path === skill.path ? 'text-[var(--primary-content)] opacity-80' : 'text-[var(--base-content-muted)]'}`}>
                          {skill.path}
                        </p>
                      </div>
